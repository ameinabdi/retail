...
export default class AccountsService {
  ...
  async create(data) {
    ...
    try {
      ...
      const record = await AccountsRepository.create(data, {
        ...this.options,
        transaction,
      });
  ...
  async update(id, data) {
    ...
    try {
      ...
      const record = await AccountsRepository.update(
        id,
        data,
        {
          ...this.options,
  ...
  async findById(id) {
    return AccountsRepository.findById(id, this.options);
  }

  async findAllAutocomplete(search, limit) {
    return AccountsRepository.findAllAutocomplete(
      search,
      limit,
      this.options,
    );
  ...
  async findAndCountAll(args) {
    return AccountsRepository.findAndCountAll(
      args,
      this.options,
    );
  }
