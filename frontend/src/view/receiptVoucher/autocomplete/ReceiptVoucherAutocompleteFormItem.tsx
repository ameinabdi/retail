...
import ReceiptVoucherFormModal from 'src/view/receiptVoucher/form/ReceiptVoucherFormModal';
...
const ReceiptVoucherAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return ReceiptVoucherService.listAutocomplete(value, limit);
  };
  ...
  const mapper = {
    toAutocomplete(value) {
      ...
      if (value.receiptNote) {
        label = value.receiptNote;
      }
...
export default ReceiptVoucherAutocompleteFormItem;
