...
const CustomerListTable = (props) => {
  ...
  const columns = [
      {
        title: i18n('entities.customer.fields.fullName'),
        sorter: true,
        dataIndex: 'fullName',
      },
      {
        title: i18n('entities.customer.fields.telephone'),
        sorter: true,
        dataIndex: 'telephone',
      },
      {
          title: i18n('entities.customer.fields.initialBalance'),
          sorter: true,
      ...
      {
        title: i18n('entities.customer.fields.shop'),
        sorter: false,
        dataIndex: 'shop',
