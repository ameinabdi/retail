...
import SellItemFormModal from 'src/view/sellItem/form/SellItemFormModal';
...
const SellItemAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return SellItemService.listAutocomplete(value, limit);
  };
...
export default SellItemAutocompleteFormItem;
