...
import SellFormModal from 'src/view/sell/form/SellFormModal';
import AutocompleteFormItem from 'src/view/shared/form/items/AutocompleteFormItem';
import { useSelector } from 'react-redux';
import selectors from 'src/modules/sell/sellSelectors';
import { useFormContext } from 'react-hook-form';

const SellAutocompleteFormItem = (props) => {
...
export default SellAutocompleteFormItem;
