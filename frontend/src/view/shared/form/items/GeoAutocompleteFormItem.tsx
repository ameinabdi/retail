...
const GeoAutocompleteFormItem = (props) => {
  const {
    //@ts-ignore
    errors,
    watch,
  ...
  const handleSelectOne = (value) => {
    ...
    setValue(name, newValue, { shouldValidate: true, shouldDirty: true });
    props.onChange && props.onChange(newValue);
    props.onSetValue && props.onSetValue(data[0]);
  };
...
GeoAutocompleteFormItem.defaultProps = {
  layout: null,
...
GeoAutocompleteFormItem.propTypes = {
...
export default GeoAutocompleteFormItem;
