...
const PaymentVoucherToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    paymentVoucherSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    paymentVoucherSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToImport && (
        <Link to="/payment-voucher/importer">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=paymentVoucher">
...
export default PaymentVoucherToolbar;
