...
import PaymentVoucherFormModal from 'src/view/paymentVoucher/form/PaymentVoucherFormModal';
...
const PaymentVoucherAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return PaymentVoucherService.listAutocomplete(value, limit);
  };
...
export default PaymentVoucherAutocompleteFormItem;
