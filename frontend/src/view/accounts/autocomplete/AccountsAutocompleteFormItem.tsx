...
import AccountsFormModal from 'src/view/accounts/form/AccountsFormModal';
...
const AccountsAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return AccountsService.listAutocomplete(value, limit);
  };
...
export default AccountsAutocompleteFormItem;
