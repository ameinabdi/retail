...
const schema = yup.object().shape({
  account: yupFilterSchemas.string(
    i18n('entities.accounts.fields.account'),
  ),
  type: yupFilterSchemas.enumerator(
    i18n('entities.accounts.fields.type'),
  ),
  openBalanceRange: yupFilterSchemas.decimalRange(
    i18n('entities.accounts.fields.openBalanceRange'),
  ),
...
const previewRenders = {
  ...
  type: {
    ...
    render: filterRenders.enumerator('entities.accounts.enumerators.type',),
  },
  openBalanceRange: {
    label: i18n('entities.accounts.fields.openBalanceRange'),
...
const AccountsListFilter = (props) => {
