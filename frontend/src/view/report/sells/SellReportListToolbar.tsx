...
const SellItemToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    sellItemSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    sellItemSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=sellItem">
...
export default SellItemToolbar;
