...
import PurchaseItemFormModal from 'src/view/purchaseItem/form/PurchaseItemFormModal';
...
const PurchaseItemAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return PurchaseItemService.listAutocomplete(value, limit);
  };
...
export default PurchaseItemAutocompleteFormItem;
