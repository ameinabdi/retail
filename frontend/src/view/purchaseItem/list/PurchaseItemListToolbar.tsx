...
const PurchaseItemToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    purchaseItemSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    purchaseItemSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToImport && (
        <Link to="/purchase-item/importer">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=purchaseItem">
...
export default PurchaseItemToolbar;
