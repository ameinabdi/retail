...
import AdvanceFormModal from 'src/view/advance/form/AdvanceFormModal';
...
const AdvanceAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return AdvanceService.listAutocomplete(value, limit);
  };
...
export default AdvanceAutocompleteFormItem;
