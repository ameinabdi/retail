...
const AdvanceToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    advanceSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    advanceSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=advance">
