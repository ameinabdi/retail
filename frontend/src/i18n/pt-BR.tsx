const ptBR = {
  ...
  entities: {
    shop: {
        ...
        label: 'Shops',
        menu: 'Shops',
        exporterFileName: 'Shop_exportados',
        list: {
          menu: 'Shops',
          title: 'Shops',
        },
        create: {
          success: 'Shop salvo com sucesso',
        },
        update: {
          success: 'Shop salvo com sucesso',
        },
        destroy: {
          success: 'Shop deletado com sucesso',
        },
        destroyAll: {
          success: 'Shop(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar Shop',
        },
        ...
        view: {
          title: 'Visualizar Shop',
        },
        importer: {
          title: 'Importar Shops',
          fileName: 'shop_template_importacao',
          hint:
    ...
    supplier: {
        ...
        importer: {
          ...
          fileName: 'supplier_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
    ...
    purchase: {
        ...
        importer: {
          ...
          fileName: 'purchase_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
    ...
    purchaseItem: {
        ...
        label: 'PurchaseItems',
        menu: 'PurchaseItems',
        exporterFileName: 'PurchaseItem_exportados',
        list: {
          menu: 'PurchaseItems',
          title: 'PurchaseItems',
        },
        create: {
          success: 'PurchaseItem salvo com sucesso',
        },
        update: {
          success: 'PurchaseItem salvo com sucesso',
        },
        destroy: {
          success: 'PurchaseItem deletado com sucesso',
        },
        destroyAll: {
          success: 'PurchaseItem(s) deletado com sucesso',
        },
        edit: {
        ...
        new: {
          title: 'Novo PurchaseItem',
        },
        view: {
          title: 'Visualizar PurchaseItem',
        },
        importer: {
          title: 'Importar PurchaseItems',
          fileName: 'purchaseItem_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
    ...
    sellItem: {
        ...
        label: 'SellItems',
        menu: 'SellItems',
        exporterFileName: 'SellItem_exportados',
        list: {
          menu: 'SellItems',
          title: 'SellItems',
        },
        create: {
          success: 'SellItem salvo com sucesso',
        },
        update: {
          success: 'SellItem salvo com sucesso',
        },
        destroy: {
          success: 'SellItem deletado com sucesso',
        },
        destroyAll: {
          success: 'SellItem(s) deletado com sucesso',
        },
        edit: {
        ...
        view: {
          title: 'Visualizar SellItem',
        },
        importer: {
          title: 'Importar SellItems',
          fileName: 'sellItem_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
    ...
    accounts: {
        ...
        label: 'Accounts',
        menu: 'Accounts',
        exporterFileName: 'Accounts_exportados',
        list: {
          menu: 'Accounts',
          title: 'Accounts',
        },
        create: {
          success: 'Accounts salvo com sucesso',
        },
        update: {
          success: 'Accounts salvo com sucesso',
        },
        ...
        destroyAll: {
          success: 'Accounts(s) deletado com sucesso',
        },
        edit: {
        ...
        view: {
          title: 'Visualizar Accounts',
        },
        importer: {
          title: 'Importar Accounts',
          fileName: 'accounts_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
